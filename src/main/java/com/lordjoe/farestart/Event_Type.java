...
public enum Event_Type {
    ...
    Baby_Shower, Birthday_Party, Fundraiser, Retirement,Tasting,Contract_Meals,Launch_Party,
    ...
    public static Event_Type remap(String theme, CateringObject obj) {
        ...
        if (theme != null) {
            ...
            Event_Type x = getEvent_type(testValue);
            if (x != null)
                return x;
        }
    ...
    private static Event_Type getEvent_type(String testValue) {
        ...
        if (testValue.contains("lunch"))
            return Lunch;
        if (testValue.contains("brunch"))
            return Lunch;
        if (testValue.contains("dinner"))
            return Dinner;
        if (testValue.contains("happy"))
            return Happy_Hour;
        if (testValue.contains("launch"))
            return Launch_Party;
